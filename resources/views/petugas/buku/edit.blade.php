    ...
    <div class="row justify-content-center">
        <div class="col-lg-11 col-xl-10">
            ...
            <div class="header-section text-center mb-5">
                ...
                <h1 class="display-5 fw-bold mb-3 gradient-text">Edit Buku</h1>
                <p class="lead text-muted">Perbarui informasi buku perpustakaan</p>
            ...
            <!-- Main Form Card -->
            <div class="form-card">
                <form action="{{ route('petugas.buku.update', $buku->id) }}" method="POST" enctype="multipart/form-data" id="bookForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-section active" data-section="1">
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p class="section-subtitle">Perbarui judul dan identitas penulis</p>
                            </div>
                        </div>
                                        ...
                                        @foreach ($allCategories as $category)
                                            <label class="category-card">
                                                <input type="radio" 
                                                       name="kategori" 
                                                       value="{{ $category }}" 
                                                       {{ old('kategori', $buku->kategori) == $category ? 'checked' : '' }}
                                                       required>
                                                <div class="category-content">
                                                    <span class="category-emoji">
                                                        @switch($category)
                                                            ...
                                                            @case('Sastra') 📚 @break
                                                            @case('Matematika') 🔢 @break
                                                            @case('Fisika') ⚛️ @break
                                                            @case('Kimia') 🧪 @break
                                                            @case('Biologi') 🔬 @break
                                                            @case('Statistika') 📈 @break
                                                            @case('Teknik Elektro') ⚡ @break
                                                            @case('Teknik Mesin') ⚙️ @break
                                                            @case('Teknik Industri') 🏭 @break
                                                            @case('Ekonomi Pembangunan') 💹 @break
                                                            @case('Bisnis Digital') 💼 @break
                                                            @case('Ilmu Komunikasi') 📢 @break
                                                            @case('Sosiologi') 👥 @break
                                                            @case('Pendidikan Matematika') 🎓 @break
                                                            @case('Pendidikan Bahasa Inggris') 🗣️ @break
                                                            @case('PGSD') 👨‍🏫 @break
                                                            @case('Keperawatan') 💉 @break
                                                            @case('Farmasi') 💊 @break
                                                            @case('Kesehatan Masyarakat') 🏥 @break
                                                            @case('Desain Grafis') 🎨 @break
                                                            @case('Desain Interior') 🛋️ @break
                                                            @case('Seni Rupa') 🖼️ @break
                                                            @case('Film') 🎬 @break
                                                            @default 📖 @break
                                                        @endswitch
                                                    </span>
                    ...
                    <div class="form-section" data-section="3">
                        <div class="section-header">
                            ...
                            <div>
                                ...
                                <p class="section-subtitle">Perbarui foto cover buku (opsional)</p>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="upload-zone" id="uploadZone">
                                    ...
                                    <div class="upload-content" id="uploadContent">
                                        ...
                                        <p class="upload-subtitle">untuk mengubah foto buku</p>
                                        ...
                                        <p class="upload-note">Kosongkan jika tidak ingin mengubah foto</p>
                                    </div>
