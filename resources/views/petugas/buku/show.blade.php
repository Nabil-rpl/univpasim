                                ...
                                <div class="book-details">
                                    ...
                                    <div class="title-section">
                                        ...
                                        <div class="action-buttons-top">
                                            <a href="{{ route('petugas.buku.edit', $buku->id) }}" class="btn-action edit"
                                                title="Edit Buku">
                                    ...
                                    <div class="info-grid">
                                        ...
                                        <div class="info-item">
                                            ...
                                            <div class="info-content">
                                                ...
                                                <span
                                                    class="info-value">{{ $buku->created_at->translatedFormat('d F Y') }}</span>
                                                ...
                                                <div class="qr-display">
                                                    <div class="qr-image-wrapper">
                                                        <img src="{{ asset('storage/' . $buku->qrCode->gambar_qr) }}"
                                                            alt="QR Code {{ $buku->judul }}" class="qr-image">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="qr-info-panel">
                                                    <div class="qr-code-field">
                                                        ...
                                                        <div class="code-display">
                                                            <input type="text" class="code-input"
                                                                value="{{ $buku->qrCode->kode_unik }}" id="kodeUnik"
                                                                readonly>
                                                    ...
                                                    <div class="qr-meta">
                                                        <div class="meta-row">
                                                            ...
                                                            <span>Dibuat oleh:
                                                                <strong>{{ $buku->qrCode->user->name ?? 'System' }}</strong></span>
                                                        </div>
                                                        <div class="meta-row">
                                                    ...
                                                    <div class="qr-actions">
                                                        <a href="{{ asset('storage/' . $buku->qrCode->gambar_qr) }}"
                                                            download="QR-{{ Str::slug($buku->judul) }}.png"
                                                        ...
                                                        <form
                                                            action="{{ route('petugas.qrcode.destroy', $buku->qrCode->id) }}"
                                                            method="POST" class="d-inline"
    ...
    <style>
        ...
        @media (min-width: 768px) {
            .qr-content {
                ...
                /* QR di kiri, info di kanan di desktop */
                gap: 32px;
            }
        }
