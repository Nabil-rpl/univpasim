                                    ...
                                    <div class="form-group-modern">
                                        ...
                                        <div class="input-wrapper">
                                            <input type="text" name="judul"
                                                ...
                                                value="{{ old('judul') }}"
                                                placeholder="Contoh: Pemrograman Web Modern dengan Laravel" required>
                                    ...
                                    <div class="form-group-modern">
                                        ...
                                        <div class="input-wrapper">
                                            <input type="text" name="penulis"
                                                ...
                                                value="{{ old('penulis') }}" placeholder="Contoh: John Doe" required>
                                            <div class="input-border"></div>
                                        </div>
                                        @error('penulis')
                                            <div class="error-message">
                                    ...
                                    <div class="form-group-modern">
                                        ...
                                        <div class="input-wrapper">
                                            <input type="text" name="penerbit"
                                                ...
                                                value="{{ old('penerbit') }}" placeholder="Contoh: Gramedia Pustaka"
                                                required>
                                            <div class="input-border"></div>
                                        </div>
                                        @error('penerbit')
                                    ...
                                    <div class="form-group-modern">
                                        ...
                                        <div class="input-wrapper">
                                            <input type="number" name="tahun_terbit"
                                                ...
                                                value="{{ old('tahun_terbit') }}" placeholder="2024" min="1900"
                                                max="2100" required>
                                            <div class="input-border"></div>
                                        </div>
                                        @error('tahun_terbit')
                                        ...
                                        <div class="categories-grid">
                                            @foreach ($categories as $category)
                                                <label class="category-card">
                                                    <input type="radio" name="kategori" value="{{ $category }}"
                                                        {{ old('kategori') == $category ? 'checked' : '' }} required>
                                ...
                                <div class="col-12">
                                    <div class="upload-zone" id="uploadZone">
                                        <input type="file" name="foto"
                                            class="upload-input @error('foto') is-invalid @enderror" accept="image/*"
                                            id="fotoInput" onchange="handleFileSelect(event)">
