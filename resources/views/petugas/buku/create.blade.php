            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body py-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="mb-1 fw-bold text-dark">➕ Tambah Buku Baru</h3>
                            <p class="text-muted mb-0">Lengkapi form di bawah untuk menambahkan buku ke perpustakaan</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="upload-area border border-2 border-dashed rounded-3 p-4 text-center bg-light">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <p class="text-muted mb-0">Klik untuk memilih foto atau drag & drop</p>
