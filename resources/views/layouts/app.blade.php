...
@media (max-width: 576px) {
    ...
    .user-role {
        display: none;           /* Role disembunyikan di HP kecil */
    }
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="{{ route('admin.mahasiswa.index') }}"
                    class="{{ request()->routeIs('admin.mahasiswa.*') ? 'active' : '' }}" id="mahasiswaLink">
            ...
            <li>
                <a href="{{ route('admin.peminjaman.index') }}"
                    class="{{ request()->routeIs('admin.peminjaman.*') ? 'active' : '' }}" id="peminjamanLink">
            ...
            <li>
                <a href="{{ route('admin.perpanjangan.index') }}"
                    class="{{ request()->routeIs('admin.perpanjangan.*') ? 'active' : '' }}" id="perpanjanganLink">
            ...
            <li>
                <a href="{{ route('admin.notifikasi.index') }}"
                    class="{{ request()->routeIs('admin.notifikasi.*') ? 'active' : '' }}" id="notifikasiLink">
                    ...
                    @if ($unreadNotifCount > 0)
                        <span class="menu-badge"
                            id="notifikasiBadge">{{ $unreadNotifCount > 99 ? '99+' : $unreadNotifCount }}</span>
                    @endif
                </a>
            </li>
            ...
            <div class="navbar-right">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end notification-dropdown">
                        <!-- notification content tetap sama -->
