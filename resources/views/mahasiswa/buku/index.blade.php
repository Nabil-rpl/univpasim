...
<div class="book-list-container">
    <div class="container">
        ...
        <div class="results-info">
            ...
            <a href="{{ route('mahasiswa.buku.index') }}" class="btn btn-sm btn-outline-primary" style="border-radius: 10px; padding: 0.5rem 1rem;">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="book-card">
                        ...
                        <div class="book-card-body">
                            ...
                            <a href="{{ route('mahasiswa.buku.show', $item->id) }}" class="btn-detail">
            ...
            @empty
                <div class="col-12">
                    <div class="empty-state">
                        ...
                        <a href="{{ route('mahasiswa.buku.index') }}" class="btn-reset">
