...
@section('content')
            ...
            <div class="col-12">
                <div class="status-card status-active">
                    ...
                    <div class="status-content">
                        ...
                        <p class="status-text">Akun Anda terdaftar sebagai Pengguna Umum. Batas peminjaman: 2 buku, maksimal
                            7 hari</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body-custom">
                        ...
                        @else
                            <div class="info-box info-box-success">
                                ...
                                <div class="info-box-text">
                                    Anda dapat meminjam hingga <strong>2 buku</strong> dengan durasi maksimal <strong>7
                                        hari</strong>.
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="activity-list">
                                @foreach ($riwayatPeminjaman as $p)
                                    <div class="activity-item">
                                        ...
                                        <a href="{{ route('pengguna-luar.peminjaman.show', $p->id) }}"
                                            class="activity-action" aria-label="Lihat detail peminjaman">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </div>
                                @endforeach
                ...
                <div class="card-body-custom">
                    <div class="profile-info">
                        ...
                        <div class="profile-item">
                            ...
                            <div class="profile-value profile-value-email">{{ auth()->user()->email }}</div>
                        </div>
                        <div class="profile-item">
                            <div class="profile-label">
                                <i class="bi bi-telephone"></i>
    ...
    @push('styles')
        <style>
            ...
            /* Profile Value - Fix untuk teks panjang */
            .profile-value {
                font-weight: 600;
                color: var(--text-dark);
                font-size: 0.95rem;
