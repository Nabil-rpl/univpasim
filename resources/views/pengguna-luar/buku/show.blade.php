    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-custom">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('pengguna-luar.buku.index') }}">Daftar Buku</a>
                </li>
                ...
                <div class="col-lg-7">
                    <div class="book-info-section">
                            ...
                            <div class="qr-section">
                                ...
                                @if ($buku->stok > 0)
                                    @if(Route::has('pengguna-luar.qr.scanner'))
                                        <a href="{{ route('pengguna-luar.qr.scanner') }}" class="btn-scanner">
                                    ...
                                    @else
                                        <div class="alert-custom alert-warning-custom" style="margin-bottom: 0;">
                                            <i class="bi bi-info-circle-fill" style="font-size: 1.5rem;"></i>
                                            <div style="flex: 1;">
                                                Fitur QR Scanner sedang dalam pengembangan. Silakan hubungi petugas perpustakaan untuk meminjam buku.
                                            </div>
                                        </div>
                                    @endif
                                @else
                        ...
                        <div class="action-buttons">
                            <a href="{{ route('pengguna-luar.buku.index') }}" class="btn-back">
            ...
            <div class="instructions-body">
                <div class="instruction-steps">
                    ...
                    <div class="instruction-step">
                        ...
                        <div class="step-content">
                            <p>Buku berhasil dipinjam! Jangan lupa kembalikan maksimal <strong>7 hari</strong> sesuai batas peminjaman pengguna umum</p>
                        </div>
                    </div>
                </div>
            </div>
