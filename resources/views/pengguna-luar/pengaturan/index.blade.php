        ...
        <div class="settings-card">
            ...
            <div class="card-body-custom">
                ...
                @if(isset($user))
                    ...
                    {{-- SATU FORM: Profil + Password (opsional) --}}
                    <form action="{{ route('pengguna-luar.pengaturan.update') }}" method="POST">
                        @csrf
                        ...
                        <hr style="border: 1px dashed #BFDBFE; margin: 2.5rem 0;">
                        ...
                        <div class="form-section">
                            ...
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <h6>Info Penting</h6>
                                    <p>Kosongkan semua kolom password jika <strong>tidak ingin mengganti password</strong>. Jika diisi, password lama wajib benar.</p>
                                </div>
                            </div>
                        </div>
