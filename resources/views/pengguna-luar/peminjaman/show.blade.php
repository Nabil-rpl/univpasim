    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('pengguna-luar.peminjaman.riwayat') }}" class="btn btn-secondary">
        ...
        <div class="col-lg-8 mx-auto">
                    ...
                    <div class="row">
                        <div class="col-md-3 text-center mb-3 mb-md-0">
                            @if($peminjaman->buku->foto)
                                <div class="book-cover-detail-image">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <!-- Deadline Info for Pengguna Luar -->
                    @if($peminjaman->status == 'dipinjam' && isset($peminjaman->tanggal_deadline))
                        <hr class="my-3">
                        <div class="deadline-box">
                            ...
                            <div class="deadline-content">
                                ...
                                @php
                                    $daysLeft = now()->diffInDays($peminjaman->tanggal_deadline, false);
                                @endphp
                                @if($daysLeft >= 0)
                                ...
                                @else
                                    <small class="text-danger">
                                        ...
                                        Terlambat <strong>{{ abs($daysLeft) }} hari</strong>
                                    </small>
                                @endif
                            </div>
                        </div>
                    ...
                    <!-- Warning for Pengguna Luar -->
                    @if($peminjaman->status == 'dipinjam')
                        <hr class="my-3">
                        <div class="alert alert-warning mb-0">
                            <i class="bi bi-exclamation-triangle me-2"></i>
                            <strong>Perhatian:</strong> Batas peminjaman untuk pengguna umum adalah <strong>maksimal 7 hari</strong>. Harap kembalikan buku tepat waktu.
                        </div>
                    @endif
                </div>
            </div>
