...
<div class="history-container">
    <div class="container">
        ...
        <div class="page-header-custom">
            <div class="header-content">
                ...
                <div class="header-actions">
                    <a href="{{ route('pengguna-luar.buku.index') }}" class="btn-custom btn-primary-custom">
                        <i class="bi bi-book"></i>
                        Lihat Buku
                    </a>
                    <a href="{{ route('pengguna-luar.dashboard') }}" class="btn-custom btn-secondary-custom">
        ...
        <div class="filter-card-custom">
            ...
            <form method="GET" action="{{ route('pengguna-luar.peminjaman.riwayat') }}">
                <div class="row g-3">
                    <div class="col-md-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="book-icon-custom">
                                                @if ($p->buku->foto)
                                                    <img src="{{ asset('storage/' . $p->buku->foto) }}" alt="{{ $p->buku->judul }}">
                                                @else
                                    ...
                                    <td>
                                        @if ($p->status == 'dipinjam')
                                            @php
                                                $isOverdue = isset($p->tanggal_deadline) && $p->tanggal_deadline->isPast();
                                    ...
                                    <td>
                                        @if ($p->status == 'dipinjam' && isset($p->tanggal_deadline) && $p->tanggal_deadline->isPast())
                                            @php
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('pengguna-luar.peminjaman.show', $p->id) }}" class="btn-custom btn-info-custom" title="Detail">
